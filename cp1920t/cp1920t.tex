...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{splay}\mathbin{::}{}\<[11]%
\>[11]{}[\mskip1.5mu \Conid{Bool}\mskip1.5mu]\to (\fun{BTree} \;\Varid{a}\to \fun{BTree} \;\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{discollect}\mathrel{=}\Varid{lstr}\kcomp \Varid{id}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
, onde \begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{lstr}\;(\Varid{a},\Varid{x})\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mid \Varid{b}\leftarrow \Varid{x}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
podendo assim derivar uma solução para a funçao discollect. 
\begin{eqnarray*}
\start
        \ensuremath{\Varid{discollect}\mathrel{=}\Varid{lstr}\kcomp \Varid{id}}
\just\equiv{ Composição monádica (63)}
        \ensuremath{\Varid{discollect}\mathrel{=}\Varid{mu}\comp \Conid{Tlstr}\comp \Varid{id}}  
\just\equiv{ pelo enunciado da ficha 11 temos que  $\mu$ = concat = cataList([nil,conc]) , natural-id(1) }
        \ensuremath{\Varid{discollect}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\mathsf{conc}}\comp \Conid{Tlstr}}
\just\equiv{ Absorção-cata (48) }
        \ensuremath{\Varid{discollect}\mathrel{=}\Varid{cataList}\;(\alt{\Varid{nil}}{\mathsf{conc}}\comp \mathit B\;(\Varid{lstr},\Varid{id}))}
\just\equiv{ B(lstr,id) = baseList f g = id + f x g}
        \ensuremath{\Varid{discollect}\mathrel{=}\Varid{cataList}\;(\alt{\Varid{nil}}{\mathsf{conc}}\comp (\Varid{id}\mathbin{+}(\Varid{lstr}\times\Varid{id}))}
\just\equiv{ Absorção- + (22), natural-id (1) }
        \ensuremath{\Varid{discollect}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\mathsf{conc}\comp (\Varid{lstr}\times\Varid{id})}}
\just\equiv{ Universal-cata(43), inList = either nil cons }
        \ensuremath{\Varid{discollect}\comp \Varid{inList}\mathrel{=}\alt{\Varid{nil}}{\mathsf{conc}\comp (\Varid{lstr}\times\Varid{id})}\comp (\Varid{id}\mathbin{+}(\Varid{id}\times\Varid{discollect}))}
\just\equiv{ Assim pela lei de isomorfismo in/out}
        \ensuremath{\Varid{discollect}\mathrel{=}[\mskip1.5mu \Varid{nil},\mathsf{conc}\comp (\Varid{lstr}\times\Varid{id})\mskip1.5mu]\comp (\Varid{id}\mathbin{+}\Varid{id}\times\Varid{discollect})\comp \Varid{outList}}
\just\Rightarrow{ discollect = g . recList (discollect) . outList e g = [nil,conc . (lstr x id)], então discollect = cataList g}
        \ensuremath{\Varid{discollect}\mathrel{=}\Varid{cataList}\;\Varid{g}}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{discollect}\;((\Varid{a},\Varid{x})\mathbin{:}\Varid{t})\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mid \Varid{b}\leftarrow \Varid{x}\mskip1.5mu]\plus \Varid{discollect}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{Exp}\;\mathit B\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{tar}\mathrel{=}\Varid{cataExp}\;\Varid{g}}}
           \ar[r]_-{\ensuremath{\Varid{outExp}}}            
&      
    \ensuremath{{(\mathit B\mathbin{+}\Conid{A}\times{(\Conid{Exp}\;\mathit B\;\Conid{A})}^{*})}^{*}}
           \ar[d]_-{\ensuremath{(\Varid{id}\mathbin{+}\Varid{id}\times\map \;\Varid{tar})}}
\\
    \ensuremath{{(\Conid{A}\times\mathit B)}^{*}}
&
    \ensuremath{(\mathit B\mathbin{+}(\Conid{A}\times{(\Conid{A}\times\mathit B)}^{*})}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{singl}\comp \conj{\Varid{nil}}{\Varid{id}}}{\uncurry{\mathsf{fmap}}\comp (\Varid{k}\times\Varid{concat})}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;\Varid{a}\mathrel{=}(\Varid{ccat}\;\Varid{a})\times\Varid{id}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\paragraph{}A função \textbf{\ensuremath{\Varid{dic\char95 rd}}} é responsável por procurar as traduções de uma determinada palavra. 

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{getTrad}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to \Conid{Dict}\to [\mskip1.5mu \Conid{String}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{getTrad}\;[\mskip1.5mu \mskip1.5mu]\;(\Conid{Var}\;\Varid{v})\mathrel{=}[\mskip1.5mu \Varid{v}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{getTrad}\;\anonymous \;(\Conid{Var}\;\Varid{v})\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{getTrad}\;[\mskip1.5mu \mskip1.5mu]\;(\Conid{Term}\;\Varid{o}\;\Varid{l})\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{getTrad}\;(\Varid{h}\mathbin{:}\Varid{t})\;(\Conid{Term}\;\Varid{o}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \Varid{o}\equiv \Varid{h}\mathrel{=}(\Varid{concat}\comp \map \;(\Varid{getTrad}\;\Varid{t}))\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \Varid{otherwise}\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{convMaybe}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to \Conid{Maybe}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{convMaybe}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Nothing}{}\<[E]%
\\
\>[B]{}\Varid{convMaybe}\;\Varid{a}\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{listStr}\mathbin{::}\Conid{String}\to [\mskip1.5mu \Conid{String}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{listStr}\;\Varid{a}\mathrel{=}\text{\tt \char34 \char34}\mathbin{:}\map \;\Varid{singl}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 rd}\mathbin{::}\Conid{String}\to \Conid{Dict}\to \Conid{Maybe}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 rd}\mathrel{=}\Varid{curry}\;(\Varid{convMaybe}\comp \uncurry{(\Varid{getTrad}\comp \Varid{listStr})}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\paragraph{}A função \textbf{\ensuremath{\Varid{dic\char95 in}}} é responsável inserir uma novo par palavra tradução num dicionário.  
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{newEntry}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to \Conid{String}\to \Conid{Dict}\to \Conid{Dict}{}\<[E]%
\\
\>[B]{}\Varid{newEntry}\;[\mskip1.5mu \mskip1.5mu]\;\anonymous \;(\Conid{Var}\;\Varid{v})\mathrel{=}\Conid{Var}\;\Varid{v}{}\<[E]%
\\
\>[B]{}\Varid{newEntry}\;[\mskip1.5mu \mskip1.5mu]\;\text{\tt \char34 \char34}\;\Varid{d}\mathrel{=}\Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{newEntry}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{s}\;\Varid{d}\mathrel{=}\Conid{Var}\;\Varid{s}{}\<[E]%
\\
\>[B]{}\Varid{newEntry}\;(\Varid{h}\mathbin{:}\Varid{t})\;\Varid{s}\;(\Conid{Term}\;\Varid{o}\;\Varid{l})\mid \Varid{o}\equiv \Varid{h}\mathrel{=}\mathbf{if}\;(\Varid{compStr}\;\Varid{l}\;\Varid{t}\;\Varid{s})\;\mathbf{then}\;\Conid{Term}\;\Varid{o}\;(\map \;(\Varid{newEntry}\;\Varid{t}\;\Varid{s})\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{else}\;\Conid{Term}\;\Varid{o}\;(\Varid{l}\plus (\Varid{create\char95 dic}\;\Varid{t}\;\Varid{s})){}\<[E]%
\\
\>[17]{}\hsindent{11}{}\<[28]%
\>[28]{}\mid \Varid{otherwise}\mathrel{=}(\Conid{Term}\;\Varid{o}\;\Varid{l}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compStr}\mathbin{::}[\mskip1.5mu \Conid{Dict}\mskip1.5mu]\to [\mskip1.5mu \Conid{String}\mskip1.5mu]\to \Conid{String}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{compStr}\;{}\<[10]%
\>[10]{}[\mskip1.5mu \mskip1.5mu]\;\anonymous \;\text{\tt \char34 \char34}\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[B]{}\Varid{compStr}\;((\Conid{Var}\;\Varid{v})\mathbin{:}\Varid{t})\;\Varid{s1}\;\Varid{s2}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid \Varid{s2}\equiv \Varid{v}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{compStr}\;\Varid{t}\;\Varid{s1}\;\Varid{s2}){}\<[E]%
\\
\>[B]{}\Varid{compStr}\;((\Conid{Term}\;\Varid{o}\;\Varid{l})\mathbin{:}\Varid{t})\;\Varid{s1}\;\Varid{s2}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid (\Varid{head}\;\Varid{s1})\equiv \Varid{o}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{compStr}\;\Varid{t}\;\Varid{s1}\;\Varid{s2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{create\char95 dic}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to \Conid{String}\to [\mskip1.5mu \Conid{Dict}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{create\char95 dic}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{v}\mathrel{=}[\mskip1.5mu \Conid{Var}\;\Varid{v}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{create\char95 dic}\;(\Varid{h}\mathbin{:}\Varid{t})\;\Varid{v}\mathrel{=}[\mskip1.5mu \Conid{Term}\;\Varid{h}\;(\Varid{create\char95 dic}\;\Varid{t}\;\Varid{v})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 in}\mathbin{::}\Conid{String}\to \Conid{String}\to \Conid{Dict}\to \Conid{Dict}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 in}\mathrel{=}(\Varid{newEntry}\comp \Varid{listStr}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{maisDir}\mathrel{=}\Varid{cataBtree}\;\Varid{g}}}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{aux}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{aux}\;(\Varid{x},(\Varid{l},\Varid{r}))\mid (\Varid{isNothing}\;\Varid{r})\mathrel{=}\Conid{Just}\;\Varid{x}{}\<[E]%
\\
\>[9]{}\hsindent{14}{}\<[23]%
\>[23]{}\mid \Varid{otherwise}\mathrel{=}\Varid{r}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{maisEsq}\mathrel{=}\Varid{cataBtree}\;\Varid{g}}}
           \ar[r]_-{\ensuremath{\Varid{outBtree}}}            
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{maisDir}\times\Varid{maisDir})}}
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{aux}\;(\Varid{x},(\Varid{l},\Varid{r}))\mid (\Varid{isNothing}\;\Varid{l})\mathrel{=}\Conid{Just}\;\Varid{x}{}\<[E]%
\\
\>[9]{}\hsindent{14}{}\<[23]%
\>[23]{}\mid \Varid{otherwise}\mathrel{=}\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&      
     \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[u]_{\ensuremath{\Varid{insOrd'}\;\Varid{x}}}
           \ar[ul]^{\ensuremath{\Varid{insOrd}\;\Varid{x}}}
           \ar[ur]_{\ensuremath{\Varid{id}}}
}
\end{eqnarray*}
...
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd}\;\Varid{x}\;\Conid{Empty}\mathrel{=}(\Conid{Node}\;(\Varid{x},(\Conid{Empty},\Conid{Empty}))){}\<[E]%
\\
\>[B]{}\Varid{insOrd}\;\Varid{x}\;(\Conid{Node}\;(\Varid{a},(\Varid{left},\Varid{right}))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{x}\equiv \Varid{a}\mathrel{=}(\Conid{Node}\;(\Varid{x},(\Varid{left},\Varid{right}))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{x}\mathbin{<}{}\<[12]%
\>[12]{}\Varid{a}\mathrel{=}(\Conid{Node}\;(\Varid{a},((\Varid{insOrd}\;\Varid{x}\;\Varid{left}),\Varid{right}))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{x}\mathbin{>}{}\<[12]%
\>[12]{}\Varid{a}\mathrel{=}(\Conid{Node}\;(\Varid{a},(\Varid{left},(\Varid{insOrd}\;\Varid{x}\;\Varid{right})))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&      
     \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[u]_{\ensuremath{\Varid{isOrd'}}}
           \ar[ul]^{\ensuremath{\Varid{isOrd}}}
           \ar[ur]_{\ensuremath{\Varid{id}}}
}
\end{eqnarray*}
...
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isEmpty}\mathbin{::}\fun{BTree} \;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{isEmpty}\;\Conid{Empty}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{isEmpty}\;\anonymous \mathrel{=}\Conid{False}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{isOrd}\;(\Conid{Node}\;(\Varid{a},(\Varid{l},\Varid{r})))\mathrel{=}((\Varid{isEmpty}\;\Varid{l})\mathrel{\vee}\Varid{a}\mathbin{>}\Varid{maximum}\;(\Varid{preordt}\;\Varid{l})){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathrel{\wedge}((\Varid{isEmpty}\;\Varid{r})\mathrel{\vee}\Varid{a}\mathbin{<}\Varid{minimum}\;(\Varid{preordt}\;\Varid{r}))\mathrel{\wedge}(\Varid{isOrd}\;\Varid{l})\mathrel{\wedge}(\Varid{isOrd}\;\Varid{r}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{rrot}\;(\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Varid{r})))\mathrel{=}(\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Varid{r}))){}\<[E]%
\\
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{A}\times{\Conid{Bool}}^{*}}
           \ar[d]_-{\ensuremath{\Varid{splay}\mathrel{=}\Varid{cataBtree}\;\Varid{g}}}
           \ar[r]_-{\ensuremath{\Varid{outList}}}            
&      
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{Bool}\times{\Conid{Bool}}^{*}}
           \ar[d]_-{\ensuremath{(\Varid{id}\mathbin{+}\Varid{id}\times\Varid{splay})}}
\\
    \ensuremath{\fun{BTree} \;\Conid{A}}
&
    \ensuremath{(\mathrm{1}\mathbin{+}(\Conid{Bool}\times{\Conid{Bool}}^{*}}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{splay}\;\Varid{t}\;\Varid{l}\mathrel{=}{}\<[14]%
\>[14]{}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Bdt}\;\Conid{A}}
        \ar[d]_-{\ensuremath{\Varid{anaBdt}\;\Varid{g}}}
        \ar@/^1pc/[r]^{\ensuremath{\Varid{outBdt}}}
        \ar@{}[r]|-{\cong}            
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times(\Conid{Bdt}\;\Conid{A})}^2
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{anaBdt})}^2}
           \ar@/^1pc/[l]^{\ensuremath{\Varid{inBdt}}}
\\
     \ensuremath{\Conid{T}}
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times(\Conid{T})}^2
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Bdt}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{extLTree}\mathrel{=}\Varid{cataBdt}\;\Varid{g}}}
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\mathsf{LTree}\;\Conid{A}\times{\Conid{Bool}}^{*}}
           \ar[d]_-{\ensuremath{\Varid{navLTree}\mathrel{=}\Varid{cataLTree}\;\Varid{g}}}
           \ar[r]_-{\ensuremath{\Varid{outLTree}\times\Varid{outList}}}            
&
    \ensuremath{(\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A}))\times(\mathrm{1}\mathbin{+}\Conid{Bool}\times{\Conid{Bool}}^{*})}
           \ar[d]^{\ensuremath{(\Varid{id}\mathbin{+}(\Varid{navLTree}\times\Varid{navLTree}))\times(\Varid{id}\mathbin{+}\Varid{id}\times\Varid{navLTree})}}
\\
     \ensuremath{\mathsf{LTree}\;\Conid{A}}
&
     \ensuremath{(\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A}))\times(\Varid{id}\mathbin{+}\Conid{Bool}\times{\Conid{Bool}}^{*})}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{navLTree}\;\Varid{c}\mathord{@}(\Conid{Fork}\;(\Varid{x},\Varid{y}))\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{navLTree}\;(\Conid{Leaf}\;\Varid{x})\;\anonymous \mathrel{=}(\Conid{Leaf}\;\Varid{x}){}\<[E]%
\\
\>[B]{}\Varid{navLTree}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\;(\Varid{h}\mathbin{:}\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{h}\equiv \Conid{True}\mathrel{=}(\Varid{navLTree}\;\Varid{x}\;\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{h}\equiv \Conid{False}\mathrel{=}(\Varid{navLTree}\;\Varid{y}\;\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\mathsf{LTree}\;\Conid{A}\times\fun{BTree} \;\mathit B)}
           \ar[d]_-{\ensuremath{\Varid{bnavLTree}\mathrel{=}\Varid{cataLTree}\;\Varid{g}}}
           \ar[r]_-{\ensuremath{\Varid{outLTree}\times\Varid{outBTree}}}            
&
    \ensuremath{(\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A}))\times(\mathrm{1}\mathbin{+}\mathit B\times(\fun{BTree} \;\mathit B\times\fun{BTree} \;\mathit B))}
           \ar[d]^{\ensuremath{(\Varid{id}\mathbin{+}(\Varid{bnavLTree}\times\Varid{bnavLTree}))\times(\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{bnavLTree}\times\Varid{bnavLTree})}}
\\
     \ensuremath{\mathsf{LTree}\;\Conid{A}}
&
     \ensuremath{(\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A}))\times(\Varid{id}\mathbin{+}\mathit B\times(\fun{BTree} \;\mathit B\times\fun{BTree} \;\mathit B))}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}}}
}
\end{eqnarray*}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{bnavLTree}\;\Varid{c}\mathord{@}(\Conid{Fork}\;(\Varid{x},\Varid{y}))\;\Conid{Empty}\mathrel{=}\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{bnavLTree}\;(\Conid{Leaf}\;\Varid{x})\;\anonymous \mathrel{=}\Conid{Leaf}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{bnavLTree}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\;(\Conid{Node}\;(\Varid{a},(\Varid{l},\Varid{r}))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{a}\equiv \Conid{True}\mathrel{=}(\Varid{bnavLTree}\;\Varid{x}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{a}\equiv \Conid{False}\mathrel{=}(\Varid{bnavLTree}\;\Varid{y}\;\Varid{r}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{type}\;\Conid{Dim}\mathrel{=}(\Conid{Int},\Conid{Int}){}\<[E]%
\\
\>[B]{}\mathbf{type}\;\Conid{Matrix}\mathrel{=}[\mskip1.5mu [\mskip1.5mu \Conid{Picture}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\mathbf{type}\;\Conid{Pic}\mathrel{=}[\mskip1.5mu \Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{parseMatrix}\mathbin{::}\Conid{Int}\to {}\<[24]%
\>[24]{}\Conid{Pic}\to \Conid{Pic}{}\<[E]%
\\
\>[B]{}\Varid{parseMatrix}\;\Varid{n}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{parseMatrix}\;\Varid{n}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}[\mskip1.5mu \Varid{x}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{parseMatrix}\;\Varid{n}\;\Varid{list}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{n}\mathbin{>}\mathrm{0}\mathrel{=}(\Varid{head}\;\Varid{list}\mathbin{:}(\Varid{head}\;(\Varid{tail}\;\Varid{list}))\mathbin{:}\Varid{parseMatrix}\;((\Varid{n}\mathbin{-}(\length \;\Varid{list})))\;\Varid{list}){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{otherwise}\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{createMatrix}\mathbin{::}\Conid{Float}\to {}\<[27]%
\>[27]{}\Conid{Pic}\to \Conid{Matrix}{}\<[E]%
\\
\>[B]{}\Varid{createMatrix}\;\Varid{n}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{createMatrix}\;\Varid{x}\;\Varid{m}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \Varid{x}\mathbin{>}\mathrm{0}\mathrel{=}([\mskip1.5mu \Varid{parseMatrix}\;\mathrm{10}\;\Varid{m}\mskip1.5mu])\plus \Varid{createMatrix}\;(\Varid{x}\mathbin{-}\mathrm{1})\;\Varid{m}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \Varid{otherwise}\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{handleSideEffect}\mathbin{::}\Conid{Matrix}\to \Conid{Float}\to \Conid{Float}\to [\mskip1.5mu \Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{handleSideEffect}\;[\mskip1.5mu \mskip1.5mu]\;\anonymous \;\anonymous \mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{handleSideEffect}\;(\Varid{x}\mathbin{:}\Varid{xs})\;\Varid{y}\;\Varid{z}\mathrel{=}\mathbf{if}\;(\Varid{y}\equiv \mathrm{0})\;\mathbf{then}\;\Varid{handleSideEffect}\;\Varid{xs}\;(\Varid{y})\;(\Varid{z}\mathbin{+}\mathrm{80})\;\mathbf{else}\;\Varid{put}\;(\Varid{y},\Varid{z})\;(\Varid{head}\;\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbin{:}\Varid{handleSideEffect}\;\Varid{xs}\;(\Varid{y}\mathbin{-}\mathrm{80})\;(\Varid{z}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{arc}\leftarrow \Varid{permuta}\;([\mskip1.5mu \Varid{truchet1},\Varid{truchet2}\mskip1.5mu])\mathbin{::}\fun{IO}\;[\mskip1.5mu \Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{arc2}\leftarrow \Varid{permuta}\;([\mskip1.5mu \Varid{truchet1},\Varid{truchet2}\mskip1.5mu])\mathbin{::}\fun{IO}\;[\mskip1.5mu \Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{pictures}\leftarrow \Varid{permuta}\;(((\Varid{handleSideEffect}\;(\Varid{createMatrix}\;\mathrm{10}\;\Varid{arc2})\;\mathrm{10}\;\mathrm{10})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\plus (\Varid{handleSideEffect}\;(\Varid{createMatrix}\;(\mathrm{10})\;\Varid{arc})\;(\mathrm{10})\;(\mathrm{1}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\plus (\Varid{handleSideEffect}\;(\Varid{createMatrix}\;(\mathrm{10})\;\Varid{arc})\;(\mathrm{10})\;(\mathrm{2}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\plus (\Varid{handleSideEffect}\;(\Varid{createMatrix}\;(\mathrm{10})\;\Varid{arc})\;(\mathrm{10})\;(\mathrm{3}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\plus (\Varid{handleSideEffect}\;(\Varid{createMatrix}\;(\mathrm{10})\;\Varid{arc})\;(\mathrm{10})\;(\mathrm{4}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\plus (\Varid{handleSideEffect}\;(\Varid{createMatrix}\;(\mathrm{10})\;\Varid{arc})\;(\mathrm{10})\;(\mathrm{5}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\plus (\Varid{handleSideEffect}\;(\Varid{createMatrix}\;(\mathrm{10})\;\Varid{arc2})\;(\mathrm{10})\;(\mathrm{6}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\plus (\Varid{handleSideEffect}\;(\Varid{createMatrix}\;(\mathrm{10})\;\Varid{arc})\;(\mathrm{10})\;(\mathrm{7}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\plus (\Varid{handleSideEffect}\;(\Varid{createMatrix}\;(\mathrm{10})\;\Varid{arc})\;(\mathrm{10})\;(\mathrm{8}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\plus (\Varid{handleSideEffect}\;(\Varid{createMatrix}\;(\mathrm{10})\;\Varid{arc})\;(\mathrm{10})\;(\mathrm{9}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\plus (\Varid{handleSideEffect}\;(\Varid{createMatrix}\;(\mathrm{10})\;\Varid{arc})\;(\mathrm{10})\;(\mathrm{10}\mathbin{*}\mathrm{80})))\mathbin{::}\fun{IO}\;[\mskip1.5mu \Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{display}\;\Varid{janela}\;\Varid{white}\;(\Conid{Pictures}\;\Varid{pictures}){}\<[E]%
\\[\blanklineskip]%
